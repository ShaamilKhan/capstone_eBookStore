                ...
                <div className="flex items-center justify-between p-5">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-gray-500">
                      ...
                      <span className="font-medium text-gray-700">${parseFloat(order.totalAmount).toFixed(2)}</span>
                    </p>
                  </div>
                  <button
                    ...
                    {!detail ? (
                      ...
                      <>
                        {detail.items?.map(item => (
                          <div key={item.id} className="flex justify-between items-center text-sm text-gray-600 py-1 border-b border-gray-50">
